...
for (i in 1:length(filesMain)){ # cycle through each file in set
  ...
  setwd(paste("/Users/rdel1cmc/Desktop/rdel1cmc/Desktop/Carra_ACE-IT_computer/wetlands_and_coastal/todd/bureau_of_reclamation/FY21_Info/Yale_Project/YaleProject/Results/", folder, sep = '')) #adjust directory for this iteration
  ...
  for (j in 1:length(fileTrip)){
    data <- read.csv(paste('/Users/rdel1cmc/Desktop/rdel1cmc/Desktop/Carra_ACE-IT_computer/wetlands_and_coastal/todd/bureau_of_reclamation/FY21_Info/Yale_Project/YaleProject/Results/Python_results/', fileTrip, sep = '')) # read in the csv
...
setwd(paste('/Users/rdel1cmc/Desktop/rdel1cmc/Desktop/Carra_ACE-IT_computer/wetlands_and_coastal/todd/bureau_of_reclamation/FY21_Info/Yale_Project/YaleProject/Results/', folder2, sep = ''))
options(warn = 1) # prints warnings as they occur
...
for (i in 1:length(filesMain2)){ # cycle through each file in set
  ...
  setwd(paste('/Users/rdel1cmc/Desktop/rdel1cmc/Desktop/Carra_ACE-IT_computer/wetlands_and_coastal/todd/bureau_of_reclamation/FY21_Info/Yale_Project/YaleProject/Results/', folder2, sep = '')) #adjust directory for this iteration
  ...
  # inner loop that manipulates each file to get a seasonal % change summary
  for (j in 1:length(fileTrip)){
    data <- read.csv(paste('/Users/rdel1cmc/Desktop/rdel1cmc/Desktop/Carra_ACE-IT_computer/wetlands_and_coastal/todd/bureau_of_reclamation/FY21_Info/Yale_Project/YaleProject/Results/',folder2,'/',fileTrip, sep = ''))[,-1] # read in the csv
